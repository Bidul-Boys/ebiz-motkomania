...
use PrestaShop\Module\PsAccounts\Vendor\Doctrine\DBAL\DBALException;
use PrestaShop\Module\PsAccounts\Vendor\Doctrine\DBAL\Driver\ServerInfoAwareConnection;
use PrestaShop\Module\PsAccounts\Vendor\Doctrine\DBAL\Schema\Schema;
    ...
    private function getConnection()
    {
        ...
        if (null === $this->driver) {
            if ($this->conn instanceof \PDO) {
                ...
                switch (\true) {
                    case $driver instanceof \PrestaShop\Module\PsAccounts\Vendor\Doctrine\DBAL\Driver\AbstractMySQLDriver:
                    case $driver instanceof \PrestaShop\Module\PsAccounts\Vendor\Doctrine\DBAL\Driver\DrizzlePDOMySql\Driver:
                    case $driver instanceof \PrestaShop\Module\PsAccounts\Vendor\Doctrine\DBAL\Driver\Mysqli\Driver:
                    case $driver instanceof \PrestaShop\Module\PsAccounts\Vendor\Doctrine\DBAL\Driver\PDOMySql\Driver:
                    case $driver instanceof \PrestaShop\Module\PsAccounts\Vendor\Doctrine\DBAL\Driver\PDO\MySQL\Driver:
                        $this->driver = 'mysql';
                        break;
                    case $driver instanceof \PrestaShop\Module\PsAccounts\Vendor\Doctrine\DBAL\Driver\PDOSqlite\Driver:
                    case $driver instanceof \PrestaShop\Module\PsAccounts\Vendor\Doctrine\DBAL\Driver\PDO\SQLite\Driver:
                        $this->driver = 'sqlite';
                        break;
                    case $driver instanceof \PrestaShop\Module\PsAccounts\Vendor\Doctrine\DBAL\Driver\PDOPgSql\Driver:
                    case $driver instanceof \PrestaShop\Module\PsAccounts\Vendor\Doctrine\DBAL\Driver\PDO\PgSQL\Driver:
                        $this->driver = 'pgsql';
                        break;
                    case $driver instanceof \PrestaShop\Module\PsAccounts\Vendor\Doctrine\DBAL\Driver\OCI8\Driver:
                    case $driver instanceof \PrestaShop\Module\PsAccounts\Vendor\Doctrine\DBAL\Driver\PDOOracle\Driver:
                    case $driver instanceof \PrestaShop\Module\PsAccounts\Vendor\Doctrine\DBAL\Driver\PDO\OCI\Driver:
                        $this->driver = 'oci';
                        break;
                    case $driver instanceof \PrestaShop\Module\PsAccounts\Vendor\Doctrine\DBAL\Driver\SQLSrv\Driver:
                    case $driver instanceof \PrestaShop\Module\PsAccounts\Vendor\Doctrine\DBAL\Driver\PDOSqlsrv\Driver:
                    case $driver instanceof \PrestaShop\Module\PsAccounts\Vendor\Doctrine\DBAL\Driver\PDO\SQLSrv\Driver:
                        $this->driver = 'sqlsrv';
                        break;
                    default:
