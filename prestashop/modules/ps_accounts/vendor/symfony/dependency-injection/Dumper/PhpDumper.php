...
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass;
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\DependencyInjection\Compiler\CheckCircularReferencesPass;
...
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\DependencyInjection\Exception\EnvParameterException;
...
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\DumperInterface as ProxyDumper;
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\NullDumper;
...
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\DependencyInjection\TypedReference;
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\DependencyInjection\Variable;
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\ExpressionLanguage\Expression;
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\HttpKernel\Kernel;
/**
...
EOF;
    ...
    private function generateProxyClasses()
    {
        ...
        $strip = '' === $this->docStar && \method_exists('PrestaShop\\Module\\PsAccounts\\Vendor\\Symfony\\Component\\HttpKernel\\Kernel', 'stripComments');
...
, 'services', $this->doExport($id));
    ...
    private function addInlineService($id, Definition $definition, Definition $inlineDef = null, $forConstructor = \true)
    {
        $code = '';
    ...
    {
        $bagClass = $this->container->isCompiled() ? 'use PrestaShop\Module\PsAccounts\Vendor\\Symfony\\Component\\DependencyInjection\\ParameterBag\\FrozenParameterBag;' : 'use PrestaShop\Module\PsAccounts\Vendor\\Symfony\\Component\\DependencyInjection\\ParameterBag\\ParameterBag;';
