...
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\Config\Resource\ClassExistenceResource;
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\Config\Resource\ComposerResource;
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\Config\Resource\DirectoryResource;
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\Config\Resource\FileExistenceResource;
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\Config\Resource\FileResource;
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\Config\Resource\GlobResource;
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\Config\Resource\ReflectionClassResource;
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\Config\Resource\ResourceInterface;
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\DependencyInjection\Argument\IteratorArgument;
...
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\DependencyInjection\Compiler\Compiler;
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\DependencyInjection\Compiler\PassConfig;
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\DependencyInjection\Compiler\ResolveEnvPlaceholdersPass;
...
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\DependencyInjection\Extension\ExtensionInterface;
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\InstantiatorInterface;
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\RealServiceInstantiator;
...
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\DependencyInjection\ParameterBag\ParameterBagInterface;
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\EventDispatcher\ContainerAwareEventDispatcher;
...
class ContainerBuilder extends Container implements TaggedContainerInterface
{
    ...
    public function __construct(ParameterBagInterface $parameterBag = null)
    {
        ...
        $this->trackResources = \interface_exists('PrestaShop\\Module\\PsAccounts\\Vendor\\Symfony\\Component\\Config\\Resource\\ResourceInterface');
    ...
    public function setAlias($alias, $id)
    {
        ...
        if ('' === $alias || '\\' === \substr($alias, -1) || \strlen($alias) !== \strcspn($alias, "\x00\r\n'")) {
    ...
    public function setDefinition($id, Definition $definition)
    {
        ...
        $id = $this->normalizeId($id);
        if ('' === $id || '\\' === \substr($id, -1) || \strlen($id) !== \strcspn($id, "\x00\r\n'")) {
     ...
     */
    private function createService(Definition $definition, array &$inlineServices, $isConstructorArgument = \false, $id = null, $tryProxy = \true)
    {
    ...
    private function getExpressionLanguage()
    {
        if (null === $this->expressionLanguage) {
            if (!\class_exists('PrestaShop\\Module\\PsAccounts\\Vendor\\Symfony\\Component\\ExpressionLanguage\\ExpressionLanguage')) {
