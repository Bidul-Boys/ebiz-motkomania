 ...
 */
namespace PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\Config\DependencyInjection;

@\trigger_error(\sprintf('The %s class is deprecated since Symfony 3.4 and will be removed in 4.0. Use tagged iterator arguments instead.', ConfigCachePass::class), \E_USER_DEPRECATED);
...
use PrestaShop\Module\PsAccounts\Vendor\Symfony\Component\DependencyInjection\Compiler\PriorityTaggedServiceTrait;
