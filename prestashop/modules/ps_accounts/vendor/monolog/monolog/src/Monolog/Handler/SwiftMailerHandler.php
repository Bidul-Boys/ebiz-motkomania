...
use PrestaShop\Module\PsAccounts\Vendor\Swift;
/**
...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct(\PrestaShop\Module\PsAccounts\Vendor\Swift_Mailer $mailer, $message, $level = Logger::ERROR, $bubble = \true)
    {
    ...
    {
        $message = null;
        if ($this->messageTemplate instanceof \PrestaShop\Module\PsAccounts\Vendor\Swift_Message) {
            $message = clone $this->messageTemplate;
            $message->generateId();
        } elseif (\is_callable($this->messageTemplate)) {
            $message = \call_user_func($this->messageTemplate, $content, $records);
        }
        if (!$message instanceof \PrestaShop\Module\PsAccounts\Vendor\Swift_Message) {
