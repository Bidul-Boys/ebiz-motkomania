...
namespace PrestaShop\Module\PsAccounts\Vendor\Psr\Log\Test;

use PrestaShop\Module\PsAccounts\Vendor\Psr\Log\LoggerInterface;
use PrestaShop\Module\PsAccounts\Vendor\Psr\Log\LogLevel;
use PrestaShop\Module\PsAccounts\Vendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('PrestaShop\\Module\\PsAccounts\\Vendor\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('PrestaShop\\Module\\PsAccounts\\Vendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('PrestaShop\\Module\\PsAccounts\\Vendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
