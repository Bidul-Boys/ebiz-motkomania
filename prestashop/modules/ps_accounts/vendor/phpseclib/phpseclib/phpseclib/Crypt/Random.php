...
class Random
{
    ...
    static function string($length)
    {
        ...
        if ($crypto === \false) {
            ...
            switch (\true) {
                case \class_exists('PrestaShop\\Module\\PsAccounts\\Vendor\\phpseclib\\Crypt\\AES'):
                    $crypto = new AES(Base::MODE_CTR);
                    break;
                case \class_exists('PrestaShop\\Module\\PsAccounts\\Vendor\\phpseclib\\Crypt\\Twofish'):
                    $crypto = new Twofish(Base::MODE_CTR);
                    break;
                case \class_exists('PrestaShop\\Module\\PsAccounts\\Vendor\\phpseclib\\Crypt\\Blowfish'):
                    $crypto = new Blowfish(Base::MODE_CTR);
                    break;
                case \class_exists('PrestaShop\\Module\\PsAccounts\\Vendor\\phpseclib\\Crypt\\TripleDES'):
                    $crypto = new TripleDES(Base::MODE_CTR);
                    break;
                case \class_exists('PrestaShop\\Module\\PsAccounts\\Vendor\\phpseclib\\Crypt\\DES'):
                    $crypto = new DES(Base::MODE_CTR);
                    break;
                case \class_exists('PrestaShop\\Module\\PsAccounts\\Vendor\\phpseclib\\Crypt\\RC4'):
                    $crypto = new RC4();
                    break;
                default:
...
if (!\function_exists('PrestaShop\\Module\\PsAccounts\\Vendor\\phpseclib_safe_serialize')) {
    /**
